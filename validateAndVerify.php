...
if(($nagMapR_MapAPI < 0) || ($nagMapR_MapAPI > 1) || (empty($nagMapR_MapAPI)))
...
if((!is_string($nagMapR_key)) || empty($nagMapR_key)) 
...
if(($nagMapR_Reporting < 0) || ($nagMapR_Reporting > 1)  || (empty($nagMapR_Reporting)))
...
if($nagMapR_IconStyle > 2 || $nagMapR_IconStyle < 0  || (empty($nagMapR_IconStyle)))
